        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 2) {
                    ...
                    Intent myIntent0 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/0BzaRGu22V1EkVU5xSnFKWm9mM2c/view?usp=docslist_api"));
                    startActivityForResult(myIntent0, 0);
                }
                if (position == 3) {

                    Intent myIntent0 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/0BzaRGu22V1EkOV9ZMlhkMldXcVU/view?usp=docslist_api"));
                    startActivityForResult(myIntent0, 0);
                }
                if (position == 4) {

                    Intent myIntent0 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/0BzaRGu22V1EkMmU3Zzc1NUtJYzQ/view?usp=docslist_api"));
                    startActivityForResult(myIntent0, 0);
                }
