...
public class Admissions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.id_campus:
                        ...
                        break;
                    case R.id.id_map:
                        Intent i = new Intent(Admissions.this, MapsActivity.class);
                        startActivity(i);
                        drawerLayout.closeDrawers();
                        break;
        ...
        String[] adm_list = getResources().getStringArray(R.array.adm_list);

        // Binding resources Array to ListAdapter
        ArrayAdapter<String> adapter =new ArrayAdapter<String>(this, R.layout.list_item_adm, R.id.label,adm_list );
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    Intent myIntent0 = new Intent(getApplicationContext(), NewActivity0.class);
                    startActivityForResult(myIntent0, 0);
                }

                if (position == 1) {

                    Intent myIntent1 = new Intent(getApplicationContext(), NewActivity1.class);
                    startActivityForResult(myIntent1, 0);
                }
                if (position == 2) {

                    Intent myIntent2 = new Intent(getApplicationContext(), NewActivity2.class);
                    startActivityForResult(myIntent2, 0);
                }
                if (position == 3) {

                    Intent myIntent3 = new Intent(getApplicationContext(), NewActivity3.class);
                    startActivityForResult(myIntent3, 0);
                }
                if (position == 4) {

                    Intent myIntent4 = new Intent(getApplicationContext(), NewActivity4.class);
                    startActivityForResult(myIntent4, 0);
                }
                if (position == 5) {

                    Intent myIntent5 = new Intent(getApplicationContext(), NewActivity9.class);
                    startActivityForResult(myIntent5, 0);
                }
                if (position == 6) {

                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://jimsgn.org/btech_online_regform.php"));
