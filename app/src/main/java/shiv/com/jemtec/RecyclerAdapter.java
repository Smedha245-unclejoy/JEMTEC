...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder> {
    ...
    public RecyclerAdapter(ArrayList<Jims> arrayList) {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        {
            Jims jims = arrayList.get(position-1);
            holder.Sno.setText(Integer.toString(jims.getSno()));
            holder.Notice.setText(jims.getNotice());
            holder.Date.setText(jims.getDate());
        }
    }
